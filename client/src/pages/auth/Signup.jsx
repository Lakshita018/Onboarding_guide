...
import { ShieldCheck, Mail, Lock, ArrowRight, User, Compass, Sparkles, Zap } from 'lucide-react';
    ...
    <div className="min-h-screen w-full flex flex-col md:flex-row bg-[#0B0F19] text-white font-sans overflow-hidden">
      ...
      <div className="hidden md:flex md:w-1/2 bg-gradient-to-br from-[#020512] via-[#051138] to-[#0A258C] relative p-16 flex-col justify-between overflow-hidden border-r border-slate-900">
        ...
        <div className="space-y-6 max-w-md my-auto z-10">
          ...
          >
            Register your onboarding credentials. Initialize your secure profile to gain immediate access to checklist configurations, buddy assignments, and benefits details.
          </motion.p>
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center p-8 bg-[#070A13]">
        ...
        >
          ...
          <div className="space-y-2">
            <h2 className="text-2xl font-bold text-slate-100 tracking-tight">Onboarding Sign-Up</h2>
            <p className="text-xs text-slate-400">Initialize your onboarding profile credentials.</p>
          </div>
